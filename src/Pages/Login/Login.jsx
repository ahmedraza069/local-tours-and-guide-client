    ...
    if ((email, password)) {
      signIn(email, password)
        .then((res) => {
          ...
          // axios.post('https://local-tours-and-guide-server-vert.vercel.app/jwt', {email}, {withCredentials: true})
          // .then(res => {
  ...
  const handleGoogleLogin = () => {
    googleSignIn()
      .then((res) => {
        ...
        // axios.post('https://local-tours-and-guide-server-vert.vercel.app/jwt', {email: res?.user?.email}, {withCredentials: true})
        // .then(res => {
        //   console.log(res.data);
        // })
      ...
      <div className="hero-content text-center text-neutral-content py-10">
        <div className="max-w-md">
          <div className="flex justify-center items-center text-white h-screen">
            <div className="w-full max-w-md p-8 space-y-3 rounded-lg " style={{ backgroundImage: 'url("https://i.ibb.co/Y2vFWWw/cool-background-4.png")' }}>
            ...
            <button
                  ...
                  name="register"
                  id="register"
                  className="btn w-full items-center block px-10 py-3.5 text-base font-medium text-center text-white transition duration-500 ease-in-out transform border border-white shadow-lg rounded-lg " style={{ backgroundImage: 'url("https://i.ibb.co/Y2vFWWw/cool-background-4.png")' }}
                >
