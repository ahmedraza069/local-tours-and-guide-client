  ...
  return (
    ...
    >
      <div className="flex justify-between items-center">
        ...
        <div>
          <p
            className="px-4 py-3  text-xs font-semibold uppercase rounded-lg text-white"
            style={{
              backgroundImage:
      ...
      <div>
        ...
        <div className="flex justify-between py-3">
          ...
          <p
            className="px-4 py-3  font-semibold rounded-lg text-white"
            style={{
              backgroundImage:
                'url("https://i.ibb.co/Y2vFWWw/cool-background-4.png")',
            }}
        ...
        <h2 className="py-2 text-base text-gray-400">{serviceArea}</h2>
